OpenCDC Specification -- Type System Proposal -- Draft v0.2
...
May 2026 -- OpenCDC Working Group

<!-- toc:begin (generated by tools/generate_toc.py; do not edit) -->

## Table of Contents

- [OpenCDC Specification](#opencdc-specification)
- [Type System Proposal](#type-system-proposal)
- [Change Log](#change-log)
- [Abstract](#abstract)
- [1. Problem Statement](#1-problem-statement)
  - [1.1 Semantic Divergence -- Same Name, Different Meaning](#11-semantic-divergence----same-name-different-meaning)
  - [1.2 Precision and Range Incompatibility](#12-precision-and-range-incompatibility)
  - [1.3 Engine-Unique Types With No Cross-Engine Equivalent](#13-engine-unique-types-with-no-cross-engine-equivalent)
  - [1.4 LOB Capture Ambiguity](#14-lob-capture-ambiguity)
  - [1.5 Wire Encoding Edge Cases](#15-wire-encoding-edge-cases)
- [2. Design Principles](#2-design-principles)
  - [Principle 1: Lossless Carry, Not Lossless Conversion](#principle-1-lossless-carry-not-lossless-conversion)
  - [Principle 2: Two Layers -- Source Fidelity and Canonical Interoperability](#principle-2-two-layers----source-fidelity-and-canonical-interoperability)
  - [Principle 3: Named Types for All Engine-Specific Behaviors](#principle-3-named-types-for-all-engine-specific-behaviors)
  - [Principle 4: String Encoding for Exact Numeric Values](#principle-4-string-encoding-for-exact-numeric-values)
- [3. Why Apache Arrow -- Rationale and Limitations](#3-why-apache-arrow----rationale-and-limitations)
  - [3.1 What Arrow Gets Right](#31-what-arrow-gets-right)
  - [3.2 Where Arrow Is Insufficient for CDC](#32-where-arrow-is-insufficient-for-cdc)
  - [3.3 What This Proposal Takes Directly from Arrow](#33-what-this-proposal-takes-directly-from-arrow)
  - [3.4 Why Not Avro, Protobuf, or Parquet?](#34-why-not-avro-protobuf-or-parquet)
- [4. Schema Delivery Model](#4-schema-delivery-model)
  - [4.1 Adopted Model: Schema-Before-First-Use](#41-adopted-model-schema-before-first-use)
  - [4.2 Stream Ordering Guarantee -- Normative Rule](#42-stream-ordering-guarantee----normative-rule)
  - [4.3 Producer Obligations for Consumer Reconnection](#43-producer-obligations-for-consumer-reconnection)
  - [4.4 OBJECT_METADATA Event Structure](#44-object_metadata-event-structure)
  - [4.5 DML Event Value Payload -- Values Only](#45-dml-event-value-payload----values-only)
  - [4.6 LOB Overflow Signaling in Value Payloads](#46-lob-overflow-signaling-in-value-payloads)
  - [4.7 Wire Efficiency Analysis](#47-wire-efficiency-analysis)
- [5. The Two-Layer Type System](#5-the-two-layer-type-system)
  - [5.1 Column Descriptor Structure](#51-column-descriptor-structure)
  - [5.2 Layer 1: source_type -- Verbatim Source Fidelity](#52-layer-1-source_type----verbatim-source-fidelity)
  - [5.3 Layer 2: logical_type -- Canonical Interoperability Vocabulary](#53-layer-2-logical_type----canonical-interoperability-vocabulary)
- [6. Canonical Type Vocabulary](#6-canonical-type-vocabulary)
  - [6.1 Integer Types](#61-integer-types)
  - [6.2 Exact Decimal Types](#62-exact-decimal-types)
  - [6.3 Floating Point Types](#63-floating-point-types)
  - [6.4 String and Binary Types](#64-string-and-binary-types)
  - [6.5 Date and Time Types](#65-date-and-time-types)
  - [6.6 Interval Types](#66-interval-types)
  - [6.7 Boolean Types](#67-boolean-types)
  - [6.8 UUID and Identity Types](#68-uuid-and-identity-types)
  - [6.9 JSON, Document, and Spatial Types](#69-json-document-and-spatial-types)
  - [6.10 Vector Types](#610-vector-types)
  - [6.11 Engine-Specific Types](#611-engine-specific-types)
- [7. Wire Encoding Summary](#7-wire-encoding-summary)
- [8. Normative Conformance Rules](#8-normative-conformance-rules)
  - [Rule 1: No Silent Truncation](#rule-1-no-silent-truncation)
  - [Rule 2: No Semantic Reinterpretation](#rule-2-no-semantic-reinterpretation)
  - [Rule 3: LOB Null and LOB Overflow Are Distinct States](#rule-3-lob-null-and-lob-overflow-are-distinct-states)
  - [Rule 4: Timezone Offsets Must Be Preserved](#rule-4-timezone-offsets-must-be-preserved)
  - [Rule 5: Schema MUST Precede First DML -- Stream Ordering](#rule-5-schema-must-precede-first-dml----stream-ordering)
  - [Rule 6: Producers MUST Support Consumer Reconnection](#rule-6-producers-must-support-consumer-reconnection)
- [9. Wire Format Examples](#9-wire-format-examples)
  - [9.1 Oracle 23ai -- Schema Event Then DML Events](#91-oracle-23ai----schema-event-then-dml-events)
  - [9.2 MySQL 9 -- Schema Change (DDL) Sequence](#92-mysql-9----schema-change-ddl-sequence)
  - [9.3 Consumer Reconnection -- Approach 1 (Session-Scoped Schema Re-Emission)](#93-consumer-reconnection----approach-1-session-scoped-schema-re-emission)
  - [9.4 PostgreSQL 17 -- Complex Types in Schema](#94-postgresql-17----complex-types-in-schema)
- [10. Open Questions for Working Group Review](#10-open-questions-for-working-group-review)
...
OpenCDC adopts schema-before-first-use as the single mandatory baseline for schema delivery. Under this model:
...
```
{
  ...
  "partitionkey":  "1001",
  // OpenCDC payload -- values only, no type metadata repeated
  "data": {
    "table":       { "catalog": "ORCL", "schema": "FINANCE", "name": "ORDERS" },
    "primary_key": ["ORDER_ID"],
    "before": {
...
OpenCDC Type System Proposal -- Draft v0.2 -- May 2026 -- OpenCDC Working Group
